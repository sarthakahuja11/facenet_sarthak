...
class DataGenerator(tf.keras.utils.Sequence):
	...
	def __init__(self, list_IDs, output_classes, imagepaths, batch_size=2,height=250,width=250, n_channels=3,
				 shuffle=True):
		'Initialization'
		self.height=height
		self.width=width
	...
	def __data_generation(self, list_IDs_temp):
		...
		for i, ID in enumerate(list_IDs_temp):
			...
			image_path=('/media/sarthak11/DATA-2/Datasets_2/lfw_funneled/'+folder_name+'/'+imagepaths[i])
